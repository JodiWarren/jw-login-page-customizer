...
if ( ! defined( 'JW_LOGIN_PAGE_CUSTOMIZER_DIR' ) ) {
	define( 'JW_LOGIN_PAGE_CUSTOMIZER_DIR', __DIR__ . '/' );
}
...
if ( ! defined( 'JW_LOGIN_PAGE_CUSTOMIZER_PATH' ) ) {
	define( 'JW_LOGIN_PAGE_CUSTOMIZER_PATH', 'path' );
}
